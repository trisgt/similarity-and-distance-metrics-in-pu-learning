...
from preprocesado.kfold import juntar_folds_separados, cargar_fold
...
def entrenamiento_y_eval(ruta_folds, ruta_folds_pu, num_folds, cl_positivas, porcentaje_pos, nombre_codecarbon, ruta_txt, nombre_resultados):
    ...
    tracker_benchmark = EmissionsTracker(
        project_name = f"No PU {nombre_codecarbon}",
    ...
    tracker_baseline = EmissionsTracker(
        project_name = f"PU no Two-Step {nombre_codecarbon}",
        output_dir = RESULTADOS,
        output_file = "codecarbon.csv"
    )
    ...
    tracker = EmissionsTracker(
        project_name = f"PU Two-Step {nombre_codecarbon}",
        output_dir = RESULTADOS,
        output_file = "codecarbon.csv"
    )
    tracker.start()
