...
from preprocesado.pr_isolet import cargar_isolet, NUM_FOLDS, CL_POSITIVAS, PORCENTAJE_POS
...
if __name__ == "__main__":
    ...
    for fold_num in range(1, NUM_FOLDS + 1):
        ...
        X_test, y_test = cargar_isolet(RUTA_FOLDS / f"fold_{fold_num}.csv", carga_fold = True)
