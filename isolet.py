...
from config import DATASETS, ENGINEERED_DATASETS, RESULTADOS
from preprocesado.pr_isolet import cargar_isolet, CL_POSITIVAS, PORCENTAJE_POS
...
RUTA_DT_PU = ENGINEERED_DATASETS / "isolet" / "dataset.csv"

# Ruta y nombre del .txt para el modelo "baseline" (PU sin Two-Step Methods):
RUTA_TXT_BASELINE = RESULTADOS / "isolet_baseline.txt"
NOMBRE_BASELINE = "ISOLET Baseline"
...
if __name__ == "__main__":
    ...
    evaluacion_dataset(
        ...
        guardar = True,
        path_guardado = RUTA_TXT_BASELINE
    )
